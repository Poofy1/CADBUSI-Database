...
class DatabaseManager:
    ...
    def insert_images_batch(self, image_data: List[Dict[str, Any]], upsert: bool = False, update_only: bool = False) -> int:
        ...
        all_columns = [
            ...
            'has_calipers', 'has_calipers_prediction', 'caliper_boxes', 'yolo_confidence', 'has_caliper_mask', 'samus_confidence',
            'darkness', 'label', 'region_count', 'closest_fn', 'distance',
            'file_name', 'software_versions', 'manufacturer_model_name'
        ]

        string_columns = ['accession_number', 'patient_id', 'image_name', 'dicom_hash', 'caliper_boxes', 'yolo_confidence', 'samus_confidence', 'inpainted_from']
